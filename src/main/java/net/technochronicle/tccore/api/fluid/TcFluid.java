...
import net.technochronicle.tccore.api.fluid.attribute.IAttributedFluid;
...
public abstract class TcFluid extends BaseFlowingFluid implements IAttributedFluid {
    ...
    public TcFluid(@NotNull FluidState state, int burnTime, BaseFlowingFluid.Properties properties) {
        super(properties);
        this.state = state;
    ...
    public static class Source extends TcFluid {
    ...
    public static class Flowing extends TcFluid {
